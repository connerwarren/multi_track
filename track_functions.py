...
'''
    ...
    dmap = Basemap(projection='cyl',
                   ...
                   resolution='i',ax=ax)# JiM raised resolution to 'h' from 'i'
...
def multi_track(ID, depth, days, lat_incr, lon_incr, starttime):
    ...
    ''' read data points from fvcom and roms websites and store them'''                                                          # mod has to be '30yr' or 'GOM3' or 'massbay'
